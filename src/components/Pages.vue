    ...
    export default {
        ...
        methods: {
            ...
            addContentToPage(content) {
                var self = this;
                Ajax.patch(this.routes.addContent + '/' + this.sharedState.state.selectedPage.slug, JSON.stringify(content)).then(function (response) {
            ...
            createPage(index){
                var self = this;
                Ajax.put(this.routes.createPages, { page: self.pages[index] }).then( function(response) {
                    var data = response.data;
            ...
            updatePage(page) {
                ...
                Ajax.patch(this.routes.updatePages + '/' + page.old_slug, { page: page }).then( function(response) {
                    var data = response.data;
            ...
            toggleActive(page) {
                var self = this;
                Ajax.get(this.routes.toggleActive + "/" + page.slug, {}).then(function (response) {
                    var data = response.data;
                    if(data.active) {
                        self.$dispatch('fetch');
            ...
            deletePage(page) {
                var self = this;
                Ajax.delete(this.routes.deletePages+ "/" + page.slug, {}).then(function (response) {
                    var data = response.data;
                    if(data.deleted_at) {
            ...
            restorePage(page) {
                var self = this;
                Ajax.patch(this.routes.restorePages+ "/" + page.slug, {}).then(function (response) {
                    var data = response.data;
                    if(!data.deleted_at) {
