    ...
    <div style="max-height: 400px; overflow-y: scroll; padding-bottom: 0.5rem">
      ...
      <tabs>
        <tab header="Content references">
          ...
          <!--If references in selected content-->
          <div v-if="sharedState.getSelectedContent().references.length">

            <!--Clear all-->
            <button
              v-show="sharedState.getSelectedContent().references.length"
              @click.prevent="clear()"
            ...
            <div class="col col-12 p2">
              ...
              -->
              <div
                v-for="reference in sharedState.getSelectedContent().references | filterBy searchReferencesQuery | orderBy 'no'"
          ...
          <div
            ...
            <p>No references. Add some by selecting them in the editor and pressing
              <a
                @click.prevent=""
                class="p1 bg-blue white rounded">
                Ctrl-Shift-F
              </a>
            </p>
